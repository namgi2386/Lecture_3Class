...
temp = data[0]["results"][0]["properties"]

first_data["제목"] = temp["제목"]["title"][0]["text"]["content"]
first_data["일차"] = int(temp["일차"]["number"])
first_data["단계"] = temp["단계"]["select"]["name"] + "단계"
first_data["과목"] = temp["과목"]["multi_select"][0]["name"]

pprint.pprint(first_data)